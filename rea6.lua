		...
		if cmd == "bring" then
			...
			for i = 1,4 do
				...
				for i = 1,30 do
					...
					FPos(target.Character:FindFirstChildOfClass("Humanoid").RootPart.CFrame, CFrame.new(0, -1.5, 0) + target.Character:FindFirstChildOfClass("Humanoid").MoveDirection * target.Character:FindFirstChildOfClass("Humanoid").RootPart.Velocity.Magnitude / math.random(16,20))
					task.wait()
				end
				wait(0.3)
			end
